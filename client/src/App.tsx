...
import { Request, Reply } from "./Interfaces/generated/helloworld_pb";
...
const call = echoService.sayHello(request, { "custom-header-1": "value1" }, (err: grpcWeb.Error, response: Reply) => {
